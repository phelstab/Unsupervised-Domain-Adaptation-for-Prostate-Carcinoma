#!/usr/bin/env bash
# DANN (Domain Adversarial Neural Network) UDA Experiments
...
COMMON="--da-method dann --binary --backbone $BACKBONE --plot-oracle --checkpoint-interval 2 --no-early-stopping --two-splits-source --two-splits-target $LR_SCHEDULER --aug-all"

echo "========================================================"
echo "DANN UDA Experiments"
...
echo ""
echo "All DANN experiments completed! (12 runs)"
