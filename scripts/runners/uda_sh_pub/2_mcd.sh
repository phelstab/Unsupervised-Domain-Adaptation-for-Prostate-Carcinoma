#!/usr/bin/env bash
# MCD (Maximum Classifier Discrepancy) UDA Experiments
# Reduced: Simple baseline vs Full regularization
...
COMMON="--da-method mcd --binary --backbone $BACKBONE --plot-oracle --checkpoint-interval 2 --no-early-stopping --two-splits-source --two-splits-target $LR_SCHEDULER --aug-all"

echo "========================================================"
echo "MCD UDA Experiments (Reduced)"
...
echo ""
echo "All MCD experiments completed! (12 runs)"
