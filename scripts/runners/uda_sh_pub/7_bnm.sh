#!/usr/bin/env bash
# BNM (Batch Nuclear-norm Maximization) UDA Experiments
# Information Maximization category - maximizes nuclear norm of prediction matrix
# Paper: Towards Discriminability and Diversity: Batch Nuclear-norm Maximization (CVPR 2020)
...
COMMON="--da-method bnm --binary --backbone $BACKBONE --plot-oracle --checkpoint-interval 2 --no-early-stopping --two-splits-source --two-splits-target $LR_SCHEDULER --aug-all"

echo "========================================================"
echo "BNM UDA Experiments (Batch Nuclear-norm Maximization)"
echo "Category: Information Maximization"
...
echo ""
echo "All BNM experiments completed! (12 runs)"
