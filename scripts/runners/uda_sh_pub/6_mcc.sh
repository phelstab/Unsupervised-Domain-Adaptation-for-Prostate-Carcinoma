#!/usr/bin/env bash
# MCC (Minimum Class Confusion) UDA Experiments
# Information Maximization category - uses entropy-weighted class confusion matrix
...
COMMON="--da-method mcc --binary --backbone $BACKBONE --plot-oracle --checkpoint-interval 2 --no-early-stopping --two-splits-source --two-splits-target $LR_SCHEDULER --aug-all"

echo "========================================================"
echo "MCC UDA Experiments (Minimum Class Confusion)"
...
echo ""
echo "All MCC experiments completed! (12 runs)"
