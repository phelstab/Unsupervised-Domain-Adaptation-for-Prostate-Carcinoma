#!/usr/bin/env bash
# MMD (Maximum Mean Discrepancy) UDA Experiments
...
COMMON="--da-method mmd --binary --backbone $BACKBONE --plot-oracle --checkpoint-interval 2 --no-early-stopping --two-splits-source --two-splits-target $LR_SCHEDULER --aug-all"

echo "========================================================"
echo "MMD UDA Experiments"
...
echo ""
echo "All MMD experiments completed! (12 runs)"
