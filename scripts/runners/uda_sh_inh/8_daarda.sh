...
COMMON="--da-method daarda --binary --backbone $BACKBONE --plot-oracle --checkpoint-interval 2 --no-early-stopping --two-splits-source --target-cv-folds 3 --class-weights $LR_SCHEDULER $SPLIT $UULM_META --aug-all $DAARDA_ARGS"
