#!/usr/bin/env bash
# MCD gland-prior+clinical UDA Experiments for merged public source -> UULM target
cd "$(dirname "$0")/../../.."
...
echo "========================================================"
echo "MCD GLAND-PRIOR+CLINICAL UDA Experiments (RUMC+PCNN+ZGT -> UULM)"
echo "========================================================"

$PYTHON $SCRIPT $COMMON --dropout 0.3 --weight-decay 1e-4

echo
echo "All MCD gland-prior+clinical experiments completed!"
